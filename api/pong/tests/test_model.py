...
class TournamentModelTests(TestCase):
    def setUp(self):
        ...
        self.game1 = Game.objects.create(
            player1=self.user1, player2=self.user2, score_player1=12, score_player2=10
        )
        self.game2 = Game.objects.create(
            player1=self.user2, player2=self.user1, score_player1=5, score_player2=7
        )
    ...
    def test_create_tournament(self):
        ...
        self.assertIsNotNone(
            tournament.id,
            "Tournament should be created successfully and assigned an ID",
        )
    ...
    def test_blockchain_score_hash(self):
        ...
        tournament = Tournament.objects.create(
            name="Hash Test Tournament", blockchain_score_hash="abc123xyz"
        )
...
class BlockchainScoreModelTests(TestCase):
    ...
    def test_create_blockchain_score(self):
        ...
        self.assertIsNotNone(
            bc_score.id,
            "BlockchainScore should be created successfully and assigned an ID",
        )
